...
#### Résultat Seqtab_nochim
```{r}
ResultatSeqtab_nochim <- readRDS("outputs/dada2/asv_table/seqtab_nochim.rds")
ResultatSeqtab_nochim
```

#### Résultat Taxonomietsv
```{r}
ResultatTaxo <- readRDS("outputs/dada2/asv_table/taxonomy.rds")
ResultatTaxo
```
