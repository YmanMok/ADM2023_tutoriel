...
base name==\> nom du fichier string split ==\> découpage de chaine de
caractère avec comme séparateur le undersocre “*” Il y a dessus elements
découpés par * dans la chaine de caractère Si 3 valeurs alors 2 \_ pour
séparer sapply ==\> récupère le 1er element
...
![](ADM2023_files/figure-gfm/unnamed-chunk-26-1.png)<!-- -->

6.2 on enleve les séquences identiques et on garde que les séquences
représentatives.
...
assemblage ==\> contig ==\> plus de rid 1 et 2 si mismatch il enleve les
séquences
